...
|----|------|---------------------|
| V05-0-01 | **Fixture matrix** | `examples/crews/minimal.json`, `kickoff-minimal.json`, `examples/flows/minimal.json` (+ future “stress” specs); documented in README; `tests/examples_contract.rs` locks parsing |
...
| V05-0-11 | **SDK parity** | `sdk/python` examples cover validate + kickoff + poll run (align with `examples/crews/kickoff-minimal.json`) |
